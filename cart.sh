...
echo -e "\e[33mAdding Roboshop cart\e[0m"
...
echo -e "\e[33mCopying cart Service File\e[0m"
cp /home/centos/roboshop-shell-2.0/cart.service /etc/systemd/system/cart.service &>>/tmp/roboshop.log
...
#mongo --host mongodb-dev.devopspro.fun </app/schema/cart.js &>>/tmp/roboshop.log