...
cp /home/centos/roboshop-shell-2.0/user.service /etc/systemd/system/user.service &>>/tmp/roboshop.log
...
#mongo --host mongodb-dev.devopspro.fun </app/schema/user.js &>>/tmp/roboshop.log